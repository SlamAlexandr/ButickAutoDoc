...
let getShowAllButton = () => {
    return document.querySelector(".catalog__show-all button")
}
...
let clickToShowAllButton = () => {
    getShowAllButton() && getShowAllButton().click();
}
